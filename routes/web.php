...
//登陆
    ...
    Route::get('/exit', 'IndexController@outLogin');
...
/*----------------------------------------------------------------------------------*/
    ...
    // 修改个人账户信息
    Route::post("/centerset", 'SetInfoController@update');
    ...
    /* 个人主页 */
        Route::get('/center/{id}', 'ZoneController@index');
        Route::get('/center/{id}/chongzhi', 'ZoneController@chongzhi');
        Route::post('/center/chongzhi/pay', 'ZoneController@buy');
        //游戏
        Route::get("/center/10086/game","ZoneController@game");
         //调用客服
...
Route::group(['prefix'=>'admins', 'middleware"=>"myauth'],function(){
    ...
    // 客服首页
    Route::resource("service","Admins\ServiceController");
    // 添加客服
    Route::get("/service/{id}/destroy","Admins\ServiceController@destroy");
    ...
    // 广告管理
    Route::get("/ad","Admins\AdController@index");
    // 广告 上线 下线
    Route::get("/ad/edit/{id}/{lock}","Admins\AdController@edit");

    // 轮播管理
    Route::get("/lunbo","Admins\LunboController@index");
    Route::get("/lunbo/load","Admins\LunboController@load");
    Route::post("/lunbo/load","Admins\LunboController@doLoad");
    // 轮播 上线 下线
    Route::get("/lunbo/edit/{id}/{lock}","Admins\LunboController@edit");
