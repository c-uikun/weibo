    ...
    $.ajax({
        ...
        success: function(data){
            if (data.error == 0) {
                ...
                str += '<a href="/center/'+data[1].id+'"><img src="./uploads/'+data[1].face50+'" class="face-50"></a></div>';
                str += '<div class="weibo-content-box pull-right">';
                str += '<a href="/center/'+data[1].id+'"><b>'+data[1].nickname+'</b></a>';
                ...
                str += '<div class="col-md-1"><img src="./uploads/'+data[1].face50+'" class="wb-comment-face"></div>';
        ...
        success:function(data){
            if (data.data.length > 0) {
                ...
                for (var i = 0; i <= data.data.length-1; i++) {
                    ...
                    str += '<a href="/center/'+data.data[i].user_id+'"><img src="./uploads/'+data.data[i].face50+'" width="18px" height="18px"></a>';
                    str += '<a href="/center/'+data.data[i].user_id+'"><span>@'+data.data[i].nickname+'</span></a>';
        ...
        success:function(data){
            if (data.data.length > 0) {
                ...
                for (var i = 0; i <= data.data.length-1; i++) {
                    ...
                    str += '<div class=" col-md-12 weibo-content">';
                    str += '<div class="row"><div class="weibo-face-box pull-left">';
                    str += '<a href="/center/'+data.data[i].user_id+'"><img src="./uploads/'+data.data[i].face50+'" class="face-50"></a></div>';
                    str += '<div class="weibo-content-box pull-right">';
                    str += '<a href="/center/'+data.data[i].user_id+'"><b>'+data.data[i].nickname+'</b></a>'
                    ...
                    str += '<div class="row comment-edit-box">';
                    str += '<div class="col-md-1"><img src="'+myFace+'" class="wb-comment-face"></div>';
            ...
            for (var i = 0; i <= data.length - 1; i++) {
                str += '<div class="wb-comment-list">';
                    str += '<div class="pull-left comment-face-box">';
                        str += '<img src="./uploads/'+data[i].face50+'" class="wb-comment-face">';
                    str += '</div>';
                    str += '<div class="wb-comment-info">';
                        str += '<a href="/center/'+data[i].user_id+'" style="color:#eb7350">'+data[i].nickname+'</a> : ';
    ...
    $.ajax({
        ...
        success:function(data){
            if (data) {
                ...
                str += '<div class="wb-comment-list">';
                    str += '<div class="pull-left comment-face-box">';
                    str += '<img src="./uploads/'+data[0].face50+'" class="wb-comment-face">';
                    str += '</div>';
                    str += '<div class="wb-comment-info">';
                        str += '<a href="/center/'+data[0].user_id+'" style="color:#eb7350">'+data[0].nickname+'</a> : ';
        ...
        success:function(data){
            ...
            if (data.length > 0) {
                for (var i = 0; i <= data.length-1; i++) {
                    ...
                    str += '<div class=" col-md-12 weibo-content">';
                    str += '<div class="row"><div class="weibo-face-box pull-left">';
                    str += '<a href="/center/'+data[i].uid+'"><img src="./uploads/'+data[i].face50+'" class="face-50"></a></div>';
                    str += '<div class="weibo-content-box pull-right">';
                    str += '<a href="/center/'+data[i].uid+'"><b>'+data[i].nickname+'</b></a>'
