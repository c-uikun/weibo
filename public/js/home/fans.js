        ...
        success:function(data){
            ...
            if (data[0].length > 0) {
                ...
                for (var i = 0; i <= data[0].length - 1; i++) {
                    ...
                    str += '<a href="/center/'+data[0][i].follow_id+'">'
                    str += '<div class="weibo-face-box pull-left"><img src="./uploads/'+data[0][i].face50+'" class="face-50"></div>'
            ...
            if (data[1].length > 0) {
                ...
                for (var i = 0; i <= data[1].length - 1; i++) {
                    str += '<li>';
                    str += '<div class=" col-md-12 weibo-content">';
                    str += '<a href="/center/'+data[1][i].follow_id+'">'
                    str += '<div class="weibo-face-box pull-left"><img src="./uploads/'+data[1][i].face50+'" class="face-50"></div>'
                    str += '<div class="hot-person-info-big pull-left">'
        ...
        success:function(data){
            ...
            if (data[0].length > 0) {
                ...
                for (var i = 0; i <= data[0].length - 1; i++) {
                    str += '<li>';
                    str += '<div class=" col-md-12 weibo-content">';
                    str += '<a href="/center/'+data[0][i].my_id+'">'
                    str += '<div class="weibo-face-box pull-left"><img src="./uploads/'+data[0][i].face50+'" class="face-50"></div>'
                    str += '<div class="hot-person-info-big pull-left">'
                    str += '<b class="person-nickname">'+data[0][i].nickname+'</b><br>'
                    str += '<span>状态：</span><span">互相关注</span>'
            ...
            if (data[1].length > 0) {
                ...
                for (var i = 0; i <= data[1].length - 1; i++) {
                    str += '<li>';
                    str += '<div class=" col-md-12 weibo-content">';
                    str += '<a href="/center/'+data[1][i].my_id+'">'
                    str += '<div class="weibo-face-box pull-left"><img src="./uploads/'+data[1][i].face50+'" class="face-50"></div>'
                    str += '<div class="hot-person-info-big pull-left">'
                    str += '<b class="person-nickname">'+data[1][i].nickname+'</b><br>'
