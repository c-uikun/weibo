      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-gittip"></i><span> 广告管理</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{URL('admins/ad')}}"><i class="fa fa-youtube-play"></i> 广告管理</a></li>
              </ul>
            </li>
            <!-- 广告管理 -->
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-gittip"></i><span> 轮播管理</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{URL('admins/lunbo')}}"><i class="fa fa-youtube-play"></i> 轮播管理</a></li>
              </ul>
            </li>
            <!-- 轮播管理 -->
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-gittip"></i><span> 客服中心</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{URL('admins/service')}}"><i class="fa fa-youtube-play"></i> 客服管理</a></li>
                <li class="active"><a href="{{URL('admins/service/create')}}"><i class="fa fa-youtube-play"></i> 添加客服</a></li>
              </ul>
            </li>
            <!-- 客服管理 -->
