@if(session('userInfo'))
    ...
    <input type="hidden" id="myFace" value="{{ asset('uploads/'.session('userInfo')->face50) }}">
@else
                        ...
                        <li id="weibo-{{ $weibo->id }}" onmousemove="showDel({{ $weibo->id }})" onmouseout="hideDel({{ $weibo->id }})">
                            <div class=" col-md-12 weibo-content">
                                <div class="row">
                                    <div class="weibo-face-box pull-left">
                                        <a href="{{ URL('/center/'.$weibo->user_id) }}"><img src="{{ asset('uploads/'.$weibo->face50) }}" class="face-50"></a>
                                    </div>
                                    <div class="weibo-content-box pull-right">
                                        <a href="{{ URL('/center/'.$weibo->user_id) }}"><b>{{ $weibo->nickname }}</b></a>
                            ...
                            <div class="col-md-12 weibo-comment-box wb-plk" id="pl-{{ $weibo->id }}" style="display:none;">
                                <div class="row comment-edit-box">
                                    <div class="col-md-1"><img src="{{ asset('uploads/'.session('userInfo')->face50) }}" class="wb-comment-face"></div>
                            ...
                            <div class=" col-md-12 weibo-content">
                                ...
                                <div class="btn-box">
                                    <span class="person-info">
                                        <a href=""><img src="{{ asset('uploads/'.$weibo->face50) }}" width="18px" height="18px"></a>
            ...
            <div class="col-md-3 hidden-xs" id="hot-box">
                ...
                <div class="row">
                    <div class="col-md-12" id="hot-talk-list">
                        <div class="weibo-face-box my-face-box center-block"><img src="{{ asset('uploads/'.session('userInfo')->face100) }}" class="face-100"></div>
                    </div>
                    <div class="col-md-12">
                        <div id="my-name" class="center-block"><a href="{{ URL('/center/'.session('userInfo')->id) }}"><b>{{ session('userInfo')->nickname }}</b></a></div>
                    </div>
                    <div class="col-md-12" id="hot-talk-more">
                        <div class="myInfo-count" onclick="f5()"><b>{{ session('userInfo')->weibo }}</b><br>微博</div>
                        <div class="myInfo-count" onclick="lookFollow()"><b>{{ session('userInfo')->follow }}</b><br>关注</div>
                        <div class="myInfo-count" onclick="lookFans()"><b>{{ session('userInfo')->fans }}</b><br>粉丝</div>
                    </div>
                </div>
                @endif
                <!-- 个人信息结束 -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" id="hot-talk-list">
                        ...
                        @foreach(session('hotPerson') as $hot_person)
                                <li class="top-person">
                                    <a href="">
                                        <div class="weibo-face-box pull-left"><img src="{{ asset('uploads/'.$hot_person->face50) }}" class="face-50"></div>
